...
ReactDOM.render(
    React.createElement("form", {id: 'ContactForm', method: 'post', action: '/ITC_475/php/confirm.php' },
        ...
        React.createElement("input", {type: 'tel', name: 'phoneNumber', className: 'phoneNumber', placeholder: "000-000-0000", pattern: "[0-9]{3}-[0-9]{3}-[0-9]{4}", required: true}), //Phone Number
